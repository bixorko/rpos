...
var Camera = (function () {
    ...
    Camera.prototype.startRtsp = function () {
        ...
        utils.log.info("You can access stream: rtsp://<usernameInConfig>:<passwordInConfig>@%s:8554/test", utils.getIpAddress());
        utils.log.info("To make Pan-Tilt-Zoom software works, please add to your NVR URLs written below:");
